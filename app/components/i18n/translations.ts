  ...
  en: {
    ...
    navigation: {
      ...
      search: {
        open: "Open search",
        close: "Close search",
        placeholder: "Search collections, products, certificates...",
        empty: "Start typing to search the catalog.",
  ...
  fr: {
    ...
    navigation: {
      ...
      search: {
        ...
        placeholder: "Rechercher des collections, produits, certificats...",
        empty: "Commencez à taper pour rechercher dans le catalogue.",
