...
export const translations = {
  en: {
    ...
    header: {
      ...
      promoShippingTitle: "CUSTOM DESIGN",
      promoShippingText: "Tailored uniforms for every team",
      promoReturnsTitle: "GLOBAL LOGISTICS",
      promoReturnsText: "Reliable delivery across markets",
      promoLogoTitle: "ECO INNOVATION",
      promoLogoText: "Responsible fabrics and smarter production",
  ...
  fr: {
    ...
    header: {
      ...
      promoShippingTitle: "CONCEPTION SUR MESURE",
      promoShippingText: "Des uniformes adaptes a chaque equipe",
